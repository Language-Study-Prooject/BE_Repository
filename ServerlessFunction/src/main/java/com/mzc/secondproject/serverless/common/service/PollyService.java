...
/**
 * AWS Polly를 사용한 TTS(Text-to-Speech) 공통 서비스
 * 음성 합성 결과를 S3에 캐싱하여 재사용
 */
public class PollyService {
     ...
     * @param s3KeyPrefix S3 키 prefix (예: "voice/", "vocab/voice/")
     */
    public PollyService(String bucketName, String s3KeyPrefix) {
    ...
    public String generateS3Key(String id, String voice) {
        ...
        return s3KeyPrefix + id + "_" + voiceSuffix + ".mp3";
    }
