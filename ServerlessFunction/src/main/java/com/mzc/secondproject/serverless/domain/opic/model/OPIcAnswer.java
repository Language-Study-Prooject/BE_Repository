...
public class OPIcAnswer {
	...
	public double getTranscriptConfidence() {
		return transcriptConfidence;
	}
	
	public void setTranscriptConfidence(double conf) {
		this.transcriptConfidence = conf;
	}
	...
	public void setGrammarFeedback(String feedback) {
		this.grammarFeedback = feedback;
	}
	...
	public void setVocabularyFeedback(String feedback) {
		this.vocabularyFeedback = feedback;
	}
	...
	public void setContentFeedback(String feedback) {
		this.contentFeedback = feedback;
	}
	...
	public void setPronunciationFeedback(String feedback) {
		this.pronunciationFeedback = feedback;
	}
	...
	public void setSampleAnswer(String answer) {
		this.sampleAnswer = answer;
	}
	
	@DynamoDbAttribute("sampleAudioS3Key")
	public String getSampleAudioS3Key() {
		return sampleAudioS3Key;
	}
	
	public void setSampleAudioS3Key(String key) {
		this.sampleAudioS3Key = key;
	}
	...
	public void setCompletedAt(Instant time) {
